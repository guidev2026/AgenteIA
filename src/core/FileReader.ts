...
export class FileReader {
   ...
   *
   * Pipeline:
   *   1. fsp.readFile(path, 'utf-8') → buffer binário decodificado como string
   *   2. Retorna a string diretamente
   *   3. Em caso de erro (arquivo inexistente, permissão), lança exceção
   *
   ...
   *
   * Pipeline:
   *   1. fsp.readdir(path) → array de nomes (somente strings, sem metadados)
   *   2. Retorna o array diretamente
   *
